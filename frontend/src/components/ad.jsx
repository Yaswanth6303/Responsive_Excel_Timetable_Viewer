  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          >
            ...
            <button
              ...
              className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2"
            >
              {isLoading ? (
                <>
                  {" "}
        ...
        {showSheetControls &&
          (sheetNames.length > 0 || pendingChanges.sheetNames?.length > 0) && (
        ...
        {/* Sheet Selection */}
        {showSheetControls &&
          (sheetNames.length > 1 || pendingChanges.sheetNames?.length > 1) && (
            <div className="bg-white rounded-lg shadow p-6 mb-6">
              <h3 className="text-lg font-bold mb-4">Select Sheet to View</h3>
              <div className="flex flex-wrap gap-4">
                {(pendingChanges.sheetNames || sheetNames).map((sheetName) => (
                  ...
                  {getChangeSummary().map((change, index) => (
                    <div
                      ...
                      className={`
                        ...
                        ${change.type === "selection" ? "bg-purple-50" : ""}
